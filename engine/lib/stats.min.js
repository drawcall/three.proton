...
var Stats = function() {
    ...
    var g = (self.performance || Date).now(),
        e = g,
        a = 0,
    ...
    k(0);
    return { REVISION: 16, dom: c, addPanel: h, showPanel: k, begin: function() { g = (self.performance || Date).now() }, end: function() { a++;
            var c = (self.performance || Date).now();
            f.update(c - g, 200);
            if (c > e + 1E3 && (r.update(1E3 * a / (c - e), 100), e = c, a = 0, t)) {
                var d = self.performance.memory;
